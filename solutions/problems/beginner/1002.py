...
# print with 4 decimal places and required format
print(f"A={A:.4f}")
...
- float(input()) reads the radius as a floating-point number.

- pi is fixed as 3.14159.

- A = pi * (R ** 2) computes the area.
